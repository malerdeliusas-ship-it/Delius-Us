...
const NO = {
  ...
  'login.sperret': 'For mange forsøk. Prøv igjen om {min} minutter.',
  'login.forsokIgjen': 'Feil e-post eller passord. {igjen} forsøk igjen.',
...
const RO: Record<Nokkel, string> = {
  ...
  'login.sperret': 'Prea multe încercări. Reîncearcă peste {min} minute.',
  'login.forsokIgjen': 'E-mail sau parolă greșită. Au mai rămas {igjen} încercări.',
